...
public:
  ...
  (std::vector<JrlJointPtr > inJointVector) = 0;
  ...
  */
  ...
  virtual const std::vector<JrlJointPtr >&
  getActuatedJoints() const = 0;

  /// \brief Specifies the list of actuated joints.
  virtual void
  setActuatedJoints
  (std::vector<JrlJointPtr >& lActuatedJoints) = 0;
